<#
*************************************** NOTA BENE ***************************************
NON ho testato questo script perche' il modulo 'Microsoft.Graph' installa una valanga di
sottomoduli dipendenze e ci mette una vita soltanto per installarsi
*****************************************************************************************
