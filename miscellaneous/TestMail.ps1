...
$address.Text = "Mail address:"
$formail.Controls.Add($address)
$recbox = New-Object System.Windows.Forms.TextBox
$recbox.Location = New-Object System.Drawing.Point(130,20)
$recbox.Size = New-Object System.Drawing.Size(300,20)
$formail.Add_Shown({$recbox.Select()})
$formail.Controls.Add($recbox)
$OKButton = New-Object System.Windows.Forms.Button
$OKButton.Location = "150,180"
$OKButton.Size = '100,30'
$OKButton.Text = "Ok"
...
$body = "This mail has been sent from a PowerShell script"
...
Try {
    ...
    $SMTPClient.Send($addressbox.Text, $recbox.Text, $subject, $body)
